...
const Index = () => {
  return (
    <div className="min-h-screen bg-green-lightest">
      {/* Navigation */}
      <nav className="bg-white shadow-sm border-b border-green-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link to="/login">
                <Button variant="outline" className="border-green-medium text-green-darkest hover:bg-green-light">Login</Button>
              </Link>
              <Link to="/register">
                <Button className="bg-green-darkest hover:bg-green-dark">Get Started</Button>
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-green-dark mb-8 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/admin-dashboard">
                <Button size="lg" className="bg-gradient-to-r from-green-darkest to-green-dark hover:from-green-dark hover:to-green-olive">
                  Admin Dashboard
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </Link>
              <Link to="/beneficiary-portal">
                <Button size="lg" variant="outline" className="border-green-medium text-green-darkest hover:bg-green-light">
                  Beneficiary Portal
                </Button>
              </Link>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-green-darkest mb-4">
      ...
      {/* Project Abstract */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-green-light">
        <div className="max-w-4xl mx-auto">
          <Card className="border-green-medium">
            <CardHeader>
              <CardTitle className="text-2xl text-center text-green-darkest">Project Abstract</CardTitle>
            </CardHeader>
            <CardContent className="text-green-dark leading-relaxed">
              <p className="mb-4">
      ...
      {/* Footer */}
      <footer className="bg-green-darkest text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            <div className="w-8 h-8 bg-gradient-to-r from-green-olive to-green-medium rounded-lg flex items-center justify-center">
              <span className="text-green-darkest font-bold text-sm">FA</span>
            </div>
